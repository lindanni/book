...
public class BorrowreadServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    if(username!=null && !username.equals("")){ 
			 ...
			 String where=" and a.readerid=b.readerid and a.classid=c.classid and a.statusid=d.statusid and a.readerid="+readerid;
			 ...
			 Map<String,Object> data=dao.getAll("a.*,b.readername,c.classname,d.bookstatus", "book a,reader b,classname c,bookstatus d", where, "a.bookid desc",startIndex,pageSize);
	         ...
	         request.getRequestDispatcher("borrowread.jsp").forward(request, response);	 
